                            ...
                            <div class="col-12 p-0 productWrapper">
                                <div class="pd-20 card-box mb-2">
                                    <div class="form-group">
                                        <label>Product :</label>
                                        <select class="custom-select2 form-control" name="product_id[]"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="customer_phone" id="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="customer_email" id="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="customer_vat_number" id="">
