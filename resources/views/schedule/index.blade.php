                    ...
                    @can('schedule_create')
                        <div class="col-xl-12">
                            <div class="pd-20 card mb-2">
                                <form
                                    action="{{ $schedule->id ? route('schedule.update', $schedule->id) : route('schedule.store') }}"
                                    method="POST">
                                    @csrf
                                    @isset($schedule->id)
                                        @method('PUT')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control time-picker"
                                                    value="{{ old('in_time', $schedule->in_time) }}" name="in_time"
                                        ...
                                        <div class="col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control time-picker"
                                                    value="{{ old('out_time', $schedule->out_time) }}" name="out_time"
                                                    placeholder="time" type="text" />
                                                @error('out_time')
                                                    <div class="text-danger">
                                                        {{ $message }}
                                    ...
                                    <div class="form-group d-flex justify-content-end">
                                        <input type="submit" value="{{ $schedule->id ? 'Update' : 'Save' }}"
                                            class="btn btn-info">
                                    </div>
                                </form>
                            </div>
                                        ...
                                        <tbody>
                                            @foreach ($schedules as $schedule)
                                                <tr>
                                                    ...
                                                    <td>{{ $schedule->hour($schedule->in_time, $schedule->out_time) }} Hour
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
