                    ...
                    <div class="col-xl-7">
                        <div class="pd-20 card mb-2">
                            ...
                            <div class="col-12 d-flex justify-content-between mt-5">
                                <div>
                                    <span>
                                        <b>Vat Number:</b> {{ $purchase->supplier->vat_number }}
                                    </span>
                                </div>
                                <div>
                                    <span>
                                        <b>Transaction Date:</b> {{ $purchase->transaction_date }}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="col-12 d-flex mt-5">
                                ...
                                <div style="width: 86%;" class="dashed-bottom px-3">{{ $organization->organization_name }}
                                </div>
                            </div>
                            <div class="col-12 d-flex mt-3">
                                ...
                                <div style="width: 95%;" class="dashed-bottom px-3">
                                    {{ $organization->organization_address }}</div>
                            </div>
                            ...
                            <div class="col-12 d-flex justify-content-end mt-5">
                                ...
                                <div class="dashed-bottom px-3">{{ $purchase->invoice_number }}</div>
                            </div>
                            ...
                            <div class="mt-5">
                                <table class="myTable col-12" border="1">
                                    ...
                                    @foreach ($purchase->purchaseProduct as $key => $item)
                                        @php
                                            $total = $purchase->purchaseProduct->count();
                                        @endphp
                                    ...
                                    @endforeach
                                    <tr>
                                        <td colspan="2" rowspan="{{ $purchase->tax->count() + 4 }}">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            RS. {{ $amount->taxable_amount }} /-
                                        </td>
                                    </tr>

                                    @foreach ($purchase->tax as $key => $tax)
                                        <tr>
                                            <td colspan="2">
                                                <strong>{{ $tax->tax_name }} ({{ $tax->tax_rate }}%)</strong>
                                            </td>
                                            <td colspan="2">
                                                RS. {{ $amount->taxable_amount * ($tax->tax_rate / 100) }}/-
                                            </td>
                                            @php
                                            @endphp
                                        </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <label>RS. <span id="grandTotal"> {{ $amount->grand_total }} </span>/-</label>
                                        </td>
                                    </tr>
                                </table>
                            </div>
